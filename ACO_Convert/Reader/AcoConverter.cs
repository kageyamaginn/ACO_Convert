...
namespace XamlBrewer.Pcl.ColorSwatchReader
{
    ...
    public class AcoConverter
    {
        ...
        private void WriteInt16(StreamWriter sw, int value)
        {
        ...
        private void WriteInt32(StreamWriter sw, int value)
        {
        ...
        public void WriteString(StreamWriter sw, string value)
        {
        ...
        public void WriteSwatches(StreamWriter sw, FileVersion version,List<SwatchColor> colors)
        {

        }

        public void WriteAcoFile(string filename)
        {
            List<SwatchColor> colors = new List<SwatchColor>();
